describe('substitute', function() {
  ...
  it('can generate url', function() {
    ...
    equal(
      'https://example.com/moc.oof/6b8591a52be19251fd22c8559d1c6d6e/bar',
      substitute.link('http://foo.com/bar')
    );

    substitute.secret = 'bar';
    equal(
      'https://example.com/moc.oof/fa38cae1b3af34170554986c2a8ebf8e/bar',
      substitute.link('http://foo.com/bar')
    );
  });
  ...
  it('can replace image', function() {
    ...
    equal(ret, '<div><img src="https://example.com/moc.oof/fa38cae1b3af34170554986c2a8ebf8e/bar"><b>bold</b></div>');
  });
